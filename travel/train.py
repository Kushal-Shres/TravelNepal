...
ds = pd.read_csv("C:\\Users\\USER\\Desktop\\7th semester\\travelnepal\\travel\\data\\travel_place.csv") #you can plug in your own list of products or movies or books here as csv file
...
def item(id):
    return ds.loc[ds['id'] == id]['category'].tolist()[0]
