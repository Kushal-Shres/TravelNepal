...
class TestCountryField(TestCase):
    ...
    def test_flag(self):
        person = Person(name="Chris Beaven", country="NZ")
        with self.settings(STATIC_URL="/static-static/"):
            self.assertEqual(person.country.flag, "/static-static/flags/nz.gif")
    ...
    def test_COUNTRIES_FLAG_URL_setting(self):
        ...
        person = Person(name="Chris Beaven", country="NZ")
        with self.settings(
            COUNTRIES_FLAG_URL="img/flag-{code_upper}.png", STATIC_URL="/static-static/"
        ):
            self.assertEqual(person.country.flag, "/static-static/img/flag-NZ.png")
        # Custom absolute url
        with self.settings(
